...
def process_news_from_mongodb():
    ...
    db_name = "market_news_db"                 # Ganti sesuai nama database Anda
    input_collection = "market_news"           # Koleksi sumber berita
    output_collection = "ringkasan_market_news" # Koleksi target hasil ringkasan
    ...
    try:
        ...
        # Buka koleksi
        market_news_collection = db[input_collection]
        result_collection = db[output_collection]
        
        # Ambil semua berita
        berita_list = list(market_news_collection.find({}))
        ...
        try:
            output_path = "ringkasan_market_news_backup.json"
