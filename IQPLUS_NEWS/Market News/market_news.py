...
spark = SparkSession.builder \
    ...
    .config("spark.mongodb.read.connection.uri", "mongodb://localhost:27017/market_news_db.market_news") \
    .config("spark.mongodb.write.connection.uri", "mongodb://localhost:27017/market_news_db.transformed_market_news") \
    .getOrCreate()
...
df.write.format("mongodb") \
    .mode("overwrite") \
    .option("database", "market_news_db") \
    .option("collection", "transformed_market_news") \
    .save()
